...
\textbf{Multiple data sources confirm the trend:}

\bigskip

\begin{columns}[T]
\begin{column}{0.32\textwidth}
\textbf{1. Labor shifting}
\begin{itemize}
    \item Contract labor: 11.6\% $\rightarrow$ \highlight{19.5\%} of farm labor expenses
    \item (1982--2022)
\end{itemize}
\end{column}

\begin{column}{0.32\textwidth}
\textbf{2. Capital shifting}
\begin{itemize}
    \item Custom work: 16.4\% $\rightarrow$ \highlight{18.4\%} of capital expenses
    \item (2002--2022)
\end{itemize}
\end{column}

\begin{column}{0.32\textwidth}
\textbf{3. Asset ownership}
\begin{itemize}
    \item Machinery owned by services: 6.1\% $\rightarrow$ \highlight{14.1\%}
    \item (1978--2022)
\end{itemize}
\end{column}
\end{columns}
...
\textbf{Key numbers (1978--2022):}
\begin{itemize}
    \item Real crop services payroll: \highlight{+288\%} (QCEW)
    \item Real farm sales: +12\%
    \item Farm machinery value: $-$5\%; Service provider machinery: \highlight{+140\%}
\end{itemize}
...
\textbf{Why LBD?} Public data (CBP, QCEW) suppressed for \highlight{75\%} of counties with crop services---yet these counties produce \highlight{half of U.S. crops}
...
\begin{equation*}
\ln(\text{Yield}_{ct}) = \beta_0 + \beta_1 \ln(\text{Payroll}_{ct}) + \beta_2 \ln(\text{Land}_{ct}) + \beta_3 \ln(\text{AvgLand}_{ct}) + \beta_4 \text{HHI}_{ct} + \varepsilon_{ct}
\end{equation*}

\bigskip

\begin{itemize}
    \item $c$ = county, $t$ = Census year (2002, 2007, 2012, 2017)
...
\begin{frame}{The Role of Farm Scale}
...
\note{
  \begin{itemize}
    ...
    \item Large farms drive the relationship---they're the ones outsourcing
  \end{itemize}
}
...
2007--2012 & \highlight{0.030***} & \highlight{0.049***} & \highlight{0.028***} & 0.007* \\
2012--2017 & \highlight{0.035***} & $-$0.004 & $-$0.003 & 0.000 \\
...
Period & All Crops & Corn & Soybeans & Wheat \\
\midrule
2002--2007 & --- & +1.2 pp & --- & +2.7 pp \\
2007--2012 & \highlight{+4.0 pp} & \highlight{+6.6 pp} & +3.5 pp & +1.0 pp \\
2012--2017 & +4.6 pp & --- & --- & --- \\
2017--2022 & --- & +2.0 pp & --- & --- \\
\bottomrule
\end{tabular}
...
\begin{enumerate}
    ...
    Effects vary by crop type and farm scale; large farms drive the relationship
...
\textbf{Bottom line:} Organizational restructuring---vertical disintegration---appears to be an \highlight{overlooked source} of agricultural productivity growth
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Remaining farms may face higher transaction costs
    \end{itemize}
...
\begin{itemize}
    ...
    \item Suggests competitive pressure remains---good for farmers
\end{itemize}
